...
import {
  LayoutGrid, FileText, Map, ArrowLeftRight, Shield, BarChart3,
  User, Settings, Clock, Factory, Search as SearchIcon, TrendingUp,
  Users, Package, Activity, Wrench, LogOut
} from "lucide-react";
...
const Layout = ({ children }) => {
  ...
  const navigationItems = {
    FARMER: [
      ...
      { name: "Transactions", href: "/farmer/transactions", icon: ArrowLeftRight },
          ...
          <div className="bg-white border-b border-gray-200 px-6 py-4">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-2">
                ...
                <h1 className={`text-xl font-bold ${roleColors.text}`}>Plancana</h1>
              </div>
              <button
