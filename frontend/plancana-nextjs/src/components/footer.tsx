...
export default function FooterSection() {
    return (
        <footer id='footer' className="bg-stone-950 py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Plancana, All rights reserved</span>
            </div>
        </footer>
    )
}
