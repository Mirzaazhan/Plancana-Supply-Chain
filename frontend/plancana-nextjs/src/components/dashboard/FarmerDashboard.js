    ...
    <div className="space-y-6 p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                {dashboardData?.statistics?.activeBatches ||
                  batches.filter(b => ["REGISTERED", "PROCESSING", "IN_TRANSIT"].includes(b.status)).length || 0}
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                {dashboardData?.statistics?.completedBatches ||
                  batches.filter(b => ["DELIVERED", "SOLD"].includes(b.status)).length || 0}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 hover:shadow-md transition-shadow">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">Farm Locations</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                    {dashboardData?.farmerInfo?.farmName || user?.username || "My Farm"}
                  </p>
                </div>
              </div>
              {dashboardData?.farmerInfo?.farmSize && (
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Farm Size</p>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
              ...
              {dashboardData?.farmerInfo?.primaryCrops && (
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Primary Crops</p>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                      {dashboardData.farmerInfo.primaryCrops}
                    </p>
                  </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Weather Conditions</h3>
        ...
        {weatherData.loading ? (
          ...
          <div className="text-center py-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">Weather data unavailable</p>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-1 flex flex-col gap-2">
              <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                ...
                <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">{weatherData.humidity}</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                <div className="flex items-center text-gray-500 dark:text-gray-400 text-xs mb-1">
                ...
                <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">{weatherData.windSpeed}</p>
              </div>
            </div>

            {/* 5-Day Forecast */}
            <div className="md:col-span-2">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">5-Day Forecast</p>
