...
const DistributorDashboard = () => {
  ...
  const fetchWeatherData = useCallback(async (lat, lon, retryCount = 0) => {
    ...
    try {
      ...
      if (cached) {
        ...
        if (Date.now() - timestamp < CACHE_DURATION) {
          setCurrentWeatherData((prev) => ({ ...data, loading: false }));
          return;
        }
      }
    } catch (e) {
    ...
    setCurrentWeatherData((prev) => ({ ...prev, loading: true, error: false }));
    ...
    try {
      ...
      setCurrentWeatherData(weatherState);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard
          title="My Batches"
          value={dashboardStats.myBatches}
          icon={Truck}
          color="blue"
        ...
        <StatCard
          ...
          value={dashboardStats.inDistribution}
          icon={Clock}
          color="orange"
        ...
        {CurrentweatherData.loading ? (
          ...
          <div className="text-center py-6">
            ...
            <button
              ...
              className="mt-3 px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-700 rounded-lg text-sm transition-colors"
            >
              Retry
            </button>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{CurrentweatherData.temperature}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">{CurrentweatherData.humidity}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">{CurrentweatherData.windSpeed}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-900 dark:text-white capitalize">{CurrentweatherData.weather_description}</p>
