...
const QRVerificationPage = ({ batchId: propBatchId }) => {
  ...
  const journeyStages = [
    ...
    { id: "harvest", name: "Harvest", icon: "🌾", completed: true },
    {
      ...
      icon: "🏭",
      completed:
        verificationData?.supplyChainSummary?.totalStages?.includes(
          "PROCESSING"
        ),
    },
    {
    ...
    },
    {
      ...
      name: "Packaging",
      icon: "📦",
      completed: verificationData?.batchInfo?.status !== "REGISTERED",
    },
    {
      id: "distribution",
      name: "Distribution",
      icon: "🚚",
      completed:
        verificationData?.supplyChainSummary?.totalStages?.includes("DELIVERY"),
    },
  ];
      ...
      <div className="w-full px-6 lg:px-12 xl:px-16 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-2 space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">
                      {verificationData?.batchInfo?.farmer || "Farm Name"}
                    </h3>
                    <p className="text-sm text-gray-600">
                      Sustainable farming since 1985
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">
                      {verificationData?.batchInfo?.location || "Farm Location"}
                    </h4>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    {formatDate(verificationData?.batchInfo?.harvestDate)}
                  </p>
                  <div className="mt-2">
            ...
            {/* Certifications */}
            {(verificationData?.verification?.blockchain?.traceability
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {verificationData.verification.blockchain.traceability.certifications.map(
                    (cert) => (
                      <span
                        key={cert}
                      ...
                      <>
                        ...
                        <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                          <p className="text-xs text-blue-800">
                            <strong>💰 Price Transparency:</strong> Farm-gate
                            prices are recorded on blockchain to ensure fair
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900">
                    {verificationData?.batchInfo?.productType ||
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900">
                    {verificationData?.verification?.blockchain?.traceability
                      ?.quantity ||
                      verificationData?.batchInfo?.quantity ||
                      "N/A"}{" "}
                    {verificationData?.verification?.blockchain?.traceability
                      ?.unit || "kg"}
                  </span>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900">
                    {formatDate(
                      verificationData?.verification?.blockchain?.traceability
                        ?.harvestDate ||
                        verificationData?.batchInfo?.harvestDate ||
                        new Date()
                    )}
                  </span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={`text-xs px-2 py-1 rounded-full font-medium ${getStatusColor(
                      verificationData?.verification?.blockchain?.traceability
                        ?.currentStatus || verificationData?.batchInfo?.status
                    )}`}
                  >
                    {(
                      verificationData?.verification?.blockchain?.traceability
