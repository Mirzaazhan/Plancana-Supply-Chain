...
export const cropOptions = [
  ...
  },
  {
    ...
    label: "Papaya",
    cropType: "fruit",
    varieties: ["Eksotika I", "Eksotika II", "Hawaii", "Sekaki"],
  },
  {
    value: "pineapple",
    label: "Pineapple",
    cropType: "fruit",
    varieties: ["MD2", "N36", "Moris", "Josapine", "Gandul", "Sarawak"],
  },
  ...
  // Vegetables
  {
    ...
    label: "Sawi",
    cropType: "vegetable",
    varieties: ["Sawi Bunga", "Sawi Hijau", "Sawi Paichai", "Sawi Taiwan"],
  },
  {
    value: "kangkung",
    label: "Kangkung",
    cropType: "vegetable",
    varieties: ["Kangkung Darat", "Kangkung Air"],
  },
  {
    value: "kailan",
    label: "Kailan",
    cropType: "vegetable",
    varieties: ["Kailan Lokal", "Kailan Taiwan"],
  },
  {
    value: "bayam",
    label: "Bayam",
    cropType: "vegetable",
    varieties: ["Bayam Hijau", "Bayam Merah", "Bayam Brazil"],
  },
  {
    value: "cili",
    label: "Cili",
    cropType: "vegetable",
    varieties: ["Cili Merah", "Cili Hijau", "Cili Padi", "Cili Bara"],
  },
  {
    value: "terung",
    label: "Terung",
  ...
  // Cash Crops
  {
    ...
    label: "Cassava",
    cropType: "cash-crop",
    varieties: ["Ubi Kayu Putih", "Ubi Kayu Kuning", "Ubi Kayu Merah"],
  },
  {
    value: "sweet-potato",
    label: "Sweet Potato",
    cropType: "cash-crop",
    varieties: ["Keledek Oren", "Keledek Ungu", "Keledek Putih"],
  },
  {
    value: "yam",
    label: "Yam",
    cropType: "cash-crop",
    varieties: ["Keladi Cina", "Keladi Kampung", "Keladi Hitam"],
  },
  {
    value: "sugarcane",
    label: "Sugarcane",
    cropType: "cash-crop",
    varieties: ["Tebu Hitam", "Tebu Kuning", "Tebu Cina"],
  },
  ...
  // Herbs & Spices
  {
    ...
    label: "Ginger",
    cropType: "herb-spice",
    varieties: ["Halia Bara", "Halia Bentong", "Halia Tua", "Halia Merah"],
  },
  {
    value: "turmeric",
    label: "Turmeric",
    cropType: "herb-spice",
    varieties: ["Kunyit Hidup", "Kunyit Putih", "Kunyit Hitam"],
  },
  {
    value: "pandan",
    label: "Pandan",
    cropType: "herb-spice",
    varieties: ["Pandan Wangi", "Pandan Serani"],
  },
  {
    value: "serai",
    label: "Serai",
    cropType: "herb-spice",
    varieties: ["Serai Wangi", "Serai Kampung"],
  },
  ...
  // Industrial Crops
  {
    ...
    varieties: ["Matag", "Malayan Tall", "Malayan Dwarf", "Kelapa Pandan"],
  },
  {
    value: "coffee",
    label: "Coffee",
    cropType: "industrial-crop",
    varieties: ["Liberica", "Robusta", "Arabica"],
  },
  {
    value: "tea",
    label: "Tea",
    cropType: "industrial-crop",
    varieties: ["Assamica", "Sinensis"],
  },
  {
    value: "oil-palm",
    label: "Oil Palm",
    cropType: "industrial-crop",
    varieties: ["DxP Hybrid", "Tenera"],
  },
];
